...
export default class Fenlei3 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: []
    ...
    getTuijian() {
        ...
        axios.get('https://show.maoyan.com/maoyansh/myshow/ajax/performances/4;st=0;p=1;s=20;tft=0;marketLevel=0?sellChannel=13&cityId=1&lng=0&lat=0')
            .then((res) => {
                this.setState({
                    data: res.data.data,
                })
